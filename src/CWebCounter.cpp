	...
	if (webType == WEB_PHP)
	{
		if (csvOutput)
		{
			if (!php_output_file_csv.is_open())
			{
				...
				CUtil::PrintFileHeaderLine(php_output_file_csv, "RESULTS FOR PHP FILES");
		...
		else
		{
			if (!php_output_file.is_open())
			{
				...
				CUtil::PrintFileHeaderLine(php_output_file, "RESULTS FOR PHP FILES");
	...
	else if (webType == WEB_JSP)
	{
		if (csvOutput)
		{
			if (!jsp_output_file_csv.is_open())
			{
				...
				CUtil::PrintFileHeader(jsp_output_file_csv, "SLOC COUNT RESULTS", cmd);

				CUtil::PrintFileHeaderLine(jsp_output_file_csv, "RESULTS FOR JSP FILES");
		...
		else
		{
			if (!jsp_output_file.is_open())
			{
				...
				CUtil::PrintFileHeader(jsp_output_file, "SLOC COUNT RESULTS", cmd);

				CUtil::PrintFileHeaderLine(jsp_output_file, "RESULTS FOR JSP FILES");
	...
	else if (webType == WEB_ASP)
	{
		if (csvOutput)
		{
			if (!asp_output_file_csv.is_open())
			{
				...
				CUtil::PrintFileHeader(asp_output_file_csv, "SLOC COUNT RESULTS", cmd);

				CUtil::PrintFileHeaderLine(asp_output_file_csv, "RESULTS FOR ASP FILES");
		...
		else
		{
			if (!asp_output_file.is_open())
			{
				...
				CUtil::PrintFileHeader(asp_output_file, "SLOC COUNT RESULTS", cmd);

				CUtil::PrintFileHeaderLine(asp_output_file, "RESULTS FOR ASP FILES");
	...
	else if (webType == WEB_CFM)
	{
		if (csvOutput)
		{
			if (!cfm_output_file_csv.is_open())
			{
				...
				CUtil::PrintFileHeader(cfm_output_file_csv, "SLOC COUNT RESULTS", cmd);

				CUtil::PrintFileHeaderLine(cfm_output_file_csv, "RESULTS FOR ColdFusion FILES");
		...
		else
		{
			if (!cfm_output_file.is_open())
			{
				...
				CUtil::PrintFileHeader(cfm_output_file, "SLOC COUNT RESULTS", cmd);

				CUtil::PrintFileHeaderLine(cfm_output_file, "RESULTS FOR ColdFusion FILES");
	...
	else if (webType == WEB_XML)
	{
		if (csvOutput)
		{
			if (!xml_output_file_csv.is_open())
			{
				...
				CUtil::PrintFileHeader(xml_output_file_csv, "SLOC COUNT RESULTS", cmd);

				CUtil::PrintFileHeaderLine(xml_output_file_csv, "RESULTS FOR XML FILES");
		...
		else
		{
			if (!xml_output_file.is_open())
			{
				...
				CUtil::PrintFileHeader(xml_output_file, "SLOC COUNT RESULTS", cmd);

				CUtil::PrintFileHeaderLine(xml_output_file, "RESULTS FOR XML FILES");
	...
	else // html
	{
		if (csvOutput)
		{
			if (!html_output_file_csv.is_open())
			{
				...
				CUtil::PrintFileHeader(html_output_file_csv, "SLOC COUNT RESULTS", cmd);

				CUtil::PrintFileHeaderLine(html_output_file_csv, "RESULTS FOR HTML FILES");
		...
		else
		{
			if (!html_output_file.is_open())
			{
				...
				CUtil::PrintFileHeader(html_output_file, "SLOC COUNT RESULTS", cmd);

				CUtil::PrintFileHeaderLine(html_output_file, "RESULTS FOR HTML FILES");
